...
-- Pra Luminea isso geraria `sobrine_staging_sobrine_staging` (duplicado),
-- porque `+schema:` ja vem com o nome final medalhao (`sobrine_staging`,
-- `sobrine_curated`, `sobrine_delivery`).
--

...
-- Pra Luminea isso geraria `tais_arquitetura_staging_tais_arquitetura_staging` (duplicado),
-- porque `+schema:` ja vem com o nome final medalhao (`tais_arquitetura_staging`,
-- `tais_arquitetura_curated`, `tais_arquitetura_delivery`).
--
